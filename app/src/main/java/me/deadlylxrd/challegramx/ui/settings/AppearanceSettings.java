...
public class AppearanceSettings extends RecyclerViewController<Void> implements View.OnClickListener, ViewController.SettingsIntDelegate {

	private SettingsAdapter adapter;

	public AppearanceSettings(Context context, Tdlib tdlib) {
		super(context, tdlib);
	}
	...
	@Override public void onApplySettings (int id, SparseIntArray result) {
  	...
  	@Override public int getId () {
    	return R.id.AppearanceSettings;
  	}
